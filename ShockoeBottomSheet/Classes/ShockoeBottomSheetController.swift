//
//  ShockoeBottomSheet.swift
//  Pods-ShockoeBottomSheet_Tests
//
//  Created by Justin Boswell on 1/6/20.
//  Credit to https://github.com/MarioIannotta/PullUpController
import UIKit

open class ShockoeBottomSheetController: UIViewController {
    ...
    */
    ...
    private var isPortrait: Bool {
        return true
        // Commented out to keep the same behavior in landscape as portrait
...
extension UIViewController {
    ...
    */
    open func addPullUpController(_ pullUpController: ShockoeBottomSheetController,
    ...
    - parameter animated: Pass true to animate the adding; otherwise, pass false.
    */
    open func addPullUpController(containerView: UIView, _ pullUpController: ShockoeBottomSheetController,
                                  initialStickyPointOffset: CGFloat,
                                  animated: Bool) {
        addChild(pullUpController)
        pullUpController.setup(superview: containerView, initialStickyPointOffset: initialStickyPointOffset)
        pullUpController.pullUpControllerAnimate(
            action: .add,
            withDuration: animated ? 0.3 : 0,
            animations: {
    ...
    */
    open func removePullUpController(_ pullUpController: ShockoeBottomSheetController, animated: Bool) {
...
extension UIScrollView {
    ...
    */
    open func attach(to pullUpController: ShockoeBottomSheetController) {
    ...
    */
    open func detach(from pullUpController: ShockoeBottomSheetController) {
